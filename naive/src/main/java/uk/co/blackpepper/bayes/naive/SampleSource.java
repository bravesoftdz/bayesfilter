...
/**
 * A SampleSource provides examples that can be used with the {@link uk.co.blackpepper.bayes.naive.bayes.Categoriser}.
 * <p>
 * The Bayes filter needs to know two things about sample data: how many items there
 * are in the sample (e.g. how many text files) and a {@link uk.co.blackpepper.bayes.naive.bayes.Concordance}
