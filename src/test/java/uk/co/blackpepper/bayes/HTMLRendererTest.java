...
public class HTMLRendererTest {
    ...
    public void theTextIsAlwaysWrappedInTransparentStyle() {
        ...
        assertTrue("text: '" + render + "'", render.endsWith(END));
        //</editor-fold>
    }
    ...
    public void uknownWordsAreLeftAlone() {
        ...
        //<editor-fold desc="Then">
        assertEquals(START + "Hello World!" + END, render);
        //</editor-fold>
    }
    ...
    public void wordsWithProbLessThan0point1AreSolidRed() {
        ...
        //<editor-fold desc="Then">
        assertEquals(START + "<span style='color: rgba(255, 0, 0, 1.00);'>Hello</span> World!" + END, render);
        //</editor-fold>
    }
    ...
    public void wordsWithProbGreaterThan0point9AreSolidBlue() {
        ...
        //<editor-fold desc="Then">
        assertEquals(START + "Hello <span style='color: rgba(0, 0, 255, 1.00);'>World!</span>" + END, render);
        //</editor-fold>
    }
    ...
    public void wordsWithProbOf0point5AreTransparent() {
        ...
        //<editor-fold desc="Then">
        assertEquals(START + "Hello <span style='color: rgba(0, 0, 255, 0.10);'>World!</span>" + END, render);
        //</editor-fold>
    }
    ...
    public void doesNotMixUpWordsWithTheSameBeginning() {
        ...
        //<editor-fold desc="Then">
        assertEquals(START + "<span style='color: rgba(0, 0, 255, 1.00);'>Hello</span> " +
